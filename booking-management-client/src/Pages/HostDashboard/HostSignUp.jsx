...
const HostSignUp = () => {
    ...
    const from = location?.state?.pathname || "/dashboard/hostDashboard";
    ...
    const onSubmit = async (data) => {
        try {
            ...
            const response = await fetch('http://localhost:5000/infoHost', {
                method: 'POST',
                headers: {
    ...
    const handleGoogleSignIn = () => {
        googleSignIn()
            .then(result => {
                ...
                fetch('http://localhost:5000/infoHost', {
                    method: 'POST',
                    headers: {
                        'content-type': 'application/json'
                    },
        ...
        <div className='flex justify-center items-center min-h-screen'>
            <div className='flex flex-col max-w-md p-6 rounded-md sm:p-10 bg-gray-100 text-gray-900'>
                <div className='mb-8 text-center'>
                    <h1 className='my-3 text-4xl font-bold'>Host Sign Up</h1>
