...
const Card = ({result}) => {
    return (
        ...
        <div className='flex flex-col items-start my-2 py-2 space-y-2'>
          ...
          <div className='flex flex-row space-x-32'><div><p className='font-body text-[#20b759] mx-2'>${result.price}<span className='text-xs px-2'>/nignt</span> </p></div>  
            <div className='grow-1'>
              <Link to={`/room/${result._id}`}><button className='bg-slate-500 p-1 rounded text-white text-sm'>
