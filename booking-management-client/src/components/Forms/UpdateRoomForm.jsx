          ...
          <div className='grid grid-cols-2 justify-between gap-2'>
            ...
            <div className='space-y-1 text-sm'>
              ...
              <select
                ...
                className='w-full px-4 py-3 border-rose-300 focus:outline-rose-500 rounded-md'
                name='type'
                value={roomData?.type}  // Add this line to properly set the selected value
                onChange={(event) =>
          ...
          <div className='flex justify-between gap-2'>
            <div className='space-y-1 text-sm'>
              ...
              <input
                ...
                onChange={event =>
                  setRoomData({ ...roomData, price: parseInt(event.target.value, 10) || 0, })
                }
                className='w-full px-4 py-3 text-gray-800 border border-rose-300 focus:outline-rose-500 rounded-md '
                name='price'
                id='price'
            ...
            <div className='space-y-1 text-sm'>
              ...
              <input
                value={roomData?.total_guest}
                onChange={event =>
                  setRoomData({ ...roomData, total_guest: event.target.value })
                }
                className='w-full px-4 py-3 text-gray-800 border border-rose-300 focus:outline-rose-500 rounded-md '
                name='total_guest'
                id='total_guest'
