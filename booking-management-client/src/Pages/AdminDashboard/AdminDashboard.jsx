...
import { PieChart, Pie, ResponsiveContainer, Cell as RechartsCell } from 'recharts';
...
const renderCustomizedLabel = ({ cx, cy, midAngle, innerRadius, outerRadius, percent, index }) => {
  ...
  return (
    <Container>
      ...
      <div className="stats shadow pt-4 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                ...
                <div className="stat">
                    ...
                    <div className="stat-value">{status?.rooms}</div>
                    <div className="stat-desc">↗︎ 400 (22%)</div>
                </div>
                <div className="stat">
                    <div className="stat-figure text-secondary">
                    ...
                    <div className="stat-title">Cars</div>
                    <div className="stat-value">{status?.cars}</div>
                    <div className="stat-desc">↗︎ 400 (22%)</div>
                </div>
                <div className="stat">
                    <div className="stat-figure text-secondary">
                    ...
                    <div className="stat-value">{status?.blogs}</div>
                    <div className="stat-desc">↗︎ 400 (22%)</div>
                </div>
